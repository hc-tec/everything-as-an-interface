...
class SubscriptionRegistry:
    """Simple JSON-based registry for topics and webhook subscriptions.
    ...
    def __init__(self, file_path: str = "data/subscriptions.json") -> None:
    ...
    # Subscriptions
    def add_subscription(self, topic_id: str, url: str, *, secret: Optional[str] = None, headers: Optional[Dict[str, str]] = None) -> str:
        sub_id = str(uuid.uuid4())
        sub = Subscription(id=sub_id, topic_id=topic_id, url=url, secret=secret, headers=headers or {}, enabled=True)
